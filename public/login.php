                ...
                ?>
						...
						<article class="one-fourth <?php if($i % 4 == 0){ echo 'last';} ?> promo">
							...
							<div class="details">
								...
								<h5><?php echo substr( $objTourSale['nameTour'],  0, 15).'...'; ?></h5>
		...
		<div class="lb-wrap">
			...
			<div class="lb-content">
				<form action="LoginController.php" method="post">
					...
					<?php
                        if(isset($_GET['error'])){
                            echo "<p style='color: red'>Tên đăng nhập hoặc mật khẩu không hợp lệ</p>";
                        }
                    ?>
					...
					<a href="registration.php" style="width: 280px; margin-top: 10px" class="gradient-button">Đăng ký</a>
				</form>
			</div>
		</div>
	</div>

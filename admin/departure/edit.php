<?php
    ...
    $objDeparture = mysqli_fetch_assoc($result);
?>
<!DOCTYPE html>
<html lang="en">
    <?php
                ...
                <div class="container-fluid">
					...
					<div class="row heading-bg">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						  <h5 class="txt-dark">Sửa địa điểm khởi hành</h5>
						</div>
							...
							<div class="panel panel-default card-view">
								<div class="panel-wrapper collapse in">
									<div class="panel-body">
										<div class="form-wrap">
											<form action="EditController.php?id=<?php echo $objDeparture['id'] ?>" method="post">
											
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															<label class="control-label mb-10">Địa điểm khởi hành</label>		
															<input name="name" type="text" class="form-control" placeholder="Tên địa điểm khởi hành" value="<?php echo $objDeparture['name'] ?>">

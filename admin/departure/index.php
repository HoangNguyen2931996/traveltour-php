				...
				<div class="container-fluid">
					<div class="row heading-bg">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						  <h5 class="txt-dark">Địa điểm khởi hành</h5>
						</div>
					</div>
					<!-- /Title -->
					<div class="row">
											...
											<div class="table-responsive">
											  <table class="table table-hover table-bordered mb-0">
		                                        ...
		                                        ?>
													  <tr>
														<td><?php echo $id?></td>
														<td><a href="edit.php?id=<?php echo $id?>"><?php echo $name?></a></td>
														<td class="text-nowrap">
															...
															<a href="del.php?id=<?php echo $id?>" class="text-inverse" title="" data-toggle="tooltip" data-original-title="Delete"><i class="zmdi zmdi-delete txt-danger"></i></a>
														</td>
													  </tr>
												<?php 
													}
